  ...
  return (
    ...
    <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center md:w-2/3 lg:w-1/2 xl:w-1/3 md:text-left">
            <h2 className="text-2xl font-bold leading-tight text-white">Join your friends</h2>
            ...
            <form className="mt-8 lg:mt-12">
                ...
                <div className="flex items-center justify-center mt-5 h-20">
                    <button
                        ...
                        className='bg-[#d00000] h-full w-64 transition-all duration-200 hover:bg-[#6A040F] hover:scale-105 rounded-md'
                    >
