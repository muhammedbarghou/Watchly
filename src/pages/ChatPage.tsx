...
export function ChatPage() {
  const [selectedChat] = useState<{ id: string; name: string; members?: string; messages: { id: number; sender: string; content: string; time: string }[] } | null>(chatData['office-chat']);
